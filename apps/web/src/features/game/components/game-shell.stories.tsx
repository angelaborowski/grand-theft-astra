...
function ShellPreview({ initialTab, museum = false }: { initialTab?: PauseTab; museum?: boolean }) {
  const previewPlayer = museum ? player : { ...player, position: MUSEUM.exit, elevation: 0 };
...
export const MuseumOpening: Story = { render: () => <ShellPreview museum /> };
