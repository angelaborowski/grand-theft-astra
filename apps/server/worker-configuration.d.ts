/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 26f4062d0fc42a923abe78635c10657f)
// Runtime types generated with workerd@1.20260908.1 2026-09-10 nodejs_compat
interface __BaseEnv_Env {
	OPENAI_MODEL: "gpt-6-astra";
	WORLD_NAME: "red-square-records";
	OPENAI_API_KEY: string;
	WORLD: DurableObjectNamespace<import("./src/worker").World>;
	PERSON: DurableObjectNamespace<import("./src/worker").Person>;
	DECISIONS: Workflow<Parameters<import("./src/worker").AstraDecision['run']>[0]['payload']>;
	CONVERSATIONS: Workflow<Parameters<import("./src/worker").AstraConversation['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "World" | "Person";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_MODEL" | "WORLD_NAME" | "OPENAI_API_KEY">> {}
}
